...
import com.example.jpa.TokenInfoJpa;
...
public class JwtTokenInterceptor implements HandlerInterceptor {
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
        //自动排除生成token的路径,并且如果是options请求是cors跨域预请求，设置allow对应头信息return true;
        ...
        try {
            ...
            //从数据库中获取token
            TokenInfoEntity token = getDAO(TokenInfoJpa.class,request).findOne(new Specification<TokenInfoEntity>() {
                @Override
